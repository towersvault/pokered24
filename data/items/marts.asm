...
IndigoPlateauLobbyClerkText::
	script_mart ULTRA_BALL, HYPER_POTION, FULL_RESTORE, REVIVE, FULL_HEAL, ELIXER, TM_ICE_BEAM, TM_THUNDERBOLT, TM_FLAMETHROWER, TM_MEGA_DRAIN, TM_SOLARBEAM, TM_SUBMISSION, TM_ROCK_SLIDE, TM_DREAM_EATER

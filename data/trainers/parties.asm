...
Green1Data:
	...
	db 5, CHARMANDER, 0
; Route 22
	db $FF, 9, SPEAROW, 8, SQUIRTLE, 0
	db $FF, 9, SPEAROW, 8, BULBASAUR, 0
	db $FF, 9, SPEAROW, 8, CHARMANDER, 0
; Cerulean City
	db $FF, 18, SPEAROW, 15, RATTATA, 15, BELLSPROUT, 19, SQUIRTLE, 0
	db $FF, 18, SPEAROW, 15, RATTATA, 15, BELLSPROUT, 19, BULBASAUR, 0
	db $FF, 18, SPEAROW, 15, RATTATA, 15, BELLSPROUT, 19, CHARMANDER, 0
...
; Pokémon Tower 7F
	db 27, ZUBAT, GOLBAT, GOLBAT, 0
	db 28, KOFFING, DROWZEE, 0
	db 25, ZUBAT, RATTATA, RATICATE, GOLBAT, 0
; Unused
...
; Silph Co. 11F
	...
	db 42, CUBONE, DROWZEE, MAROWAK, ARBOK, 0
...
LtSurgeData:
	db $FF, 26, MAGNEMITE, 28, VOLTORB, 29, RAICHU, 0
; Rematch
...
Green2Data:
; SS Anne 2F
	db $FF, 20, RATICATE , 22, WEEPINBELL, 21, SANDSHREW, 24, WARTORTLE, 0
	db $FF, 20, RATICATE , 22, WEEPINBELL, 21, SANDSHREW, 24, IVYSAUR, 0
	db $FF, 20, RATICATE , 22, WEEPINBELL, 21, SANDSHREW, 24, CHARMELEON, 0
; Pokémon Tower 2F
	db $FF, 34, FEAROW, 32, VULPIX, 33, KADABRA, 32, SCYTHER, 35, WARTORTLE, 0
	db $FF, 34, FEAROW, 32, SHELLDER, 32, GROWLITHE, 33, KADABRA, 35, IVYSAUR, 0
	db $FF, 34, FEAROW, 32, MAGNEMITE, 33, KADABRA, 32, SHELLDER, 35, CHARMELEON, 0
; Silph Co. 7F
	db $FF, 43, VICTREEBEL, 44, PORYGON, 43, PRIMEAPE, 44, ALAKAZAM, 46, BLASTOISE, 0
	db $FF, 43, PARASECT, 44, GYARADOS, 43, RHYDON, 44, ALAKAZAM, 46, VENUSAUR, 0
	db $FF, 43, ELECTABUZZ, 44, CLOYSTER, 43, DODRIO , 44, ALAKAZAM, 46, CHARIZARD, 0
; Route 22
	db $FF, 53, PIDGEOT, 54, MACHAMP, 54, ALAKAZAM, 52, NINETALES, 52, SCYTHER, 55, BLASTOISE, 0
	db $FF, 53, PIDGEOT, 52, EXEGGUTOR , 52, MAROWAK,  54, ARCANINE, 54, ALAKAZAM, 55, VENUSAUR, 0
	db $FF, 54, FEAROW, 52, MAGNETON, 53, GOLDUCK, 54, ALAKAZAM, 52, MAROWAK, 55, CHARIZARD, 0

Green3Data:
; Champion's Room
	db $FF, 60, MACHAMP, 61, PIDGEOT, 62, NINETALES, 62, VICTREEBEL, 63, ALAKAZAM, 65, BLASTOISE, 0
	db $FF, 63, ALAKAZAM, 60, RHYDON, 61, GYARADOS, 63, ARCANINE, 62, EXEGGUTOR, 65, VENUSAUR, 0
	db $FF, 62, MAGNETON, 61, DODRIO, 63, ALAKAZAM, 60, SANDSLASH, 62, CLOYSTER, 65, CHARIZARD, 0
; Rematch
